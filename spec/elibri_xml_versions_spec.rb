...
describe Elibri::XmlVersions do
  ...
  it "should return true for same elibri objects" do
    generated_product = xml_from_mock(:basic_product)
    generated_product_2 = xml_from_mock(:basic_product)
  ...
  it "should return false for different elibri objects" do
    generated_product = xml_from_mock(:basic_product, :record_reference => 'fdb8fa072be774d97a97')
    generated_product_2 = xml_from_mock(:basic_product, :record_reference => 'fdb8fa072be774d97a95')
    @elibri_xml_versions = Elibri::XmlVersions.new(generated_product, generated_product_2)
